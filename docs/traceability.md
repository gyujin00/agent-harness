...
|-------------|-----------|------|--------|---------|-------------|------|
| FR-017 (REQ-017) | `requirements/frd.md`, `plans/sprint-01.md` | T-001 | ai | PR #2 | eval PASS: retrieval@k=0.8889, faithfulness=1.0000, answer_relevancy=1.0000 (기준선 0.80/0.85/0.80, verifier 2026-07-17) | done |
